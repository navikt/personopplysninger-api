...
import no.nav.personopplysninger.features.personaliagammel.pdl.dto.PdlResponse
import no.nav.personopplysninger.features.personaliagammel.pdl.dto.adresse.createKontaktadresseRequest
import no.nav.personopplysninger.features.personaliagammel.pdl.dto.createPersonInfoRequest
import no.nav.personopplysninger.features.personaliagammel.pdl.dto.error.PDLErrorType
import no.nav.personopplysninger.features.personaliagammel.pdl.dto.error.PdlErrorResponse
import no.nav.personopplysninger.features.personaliagammel.pdl.dto.telefon.createTelefonRequest
...
class PdlConsumerGammel(private val client: Client, private val endpoint: URI, private val stsConsumer: STSConsumer) {

    private val RETT_PERSONOPPLYSNINGER = "RPO"

    val log: Logger = LoggerFactory.getLogger(PdlConsumerGammel::class.java)
