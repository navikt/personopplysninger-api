...
class PersonaliaService @Autowired constructor(
    ...
    fun hentPersoninfo(fodselsnr: String): PersonaliaOgAdresser {
        ...
        val personfoedtkommune = (!inbound.foedtIKommune?.verdi.isNullOrBlank()).let {log.warn("Test " + foedtkommune); foedtkommune.betydninger.getValue(inbound.foedtIKommune?.verdi)[0]?.beskrivelser}
