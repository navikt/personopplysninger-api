...
import no.nav.personopplysninger.features.personalia.dto.outbound.UtenlandskAdresseDto
import no.nav.personopplysninger.features.personalia.kodeverk.PersonaliaKodeverk
import no.nav.tps.person.UtenlandskAdresse

object UtenlandskAdresseTransformer {
    fun toOutbound(inbound: UtenlandskAdresse, kodeverk: PersonaliaKodeverk) = UtenlandskAdresseDto(
