...
import no.nav.personopplysninger.features.endreopplysningergammel.domain.kontaktadresse.EndreKontaktadresse
import no.nav.personopplysninger.features.endreopplysningergammel.domain.kontaktadresse.EndringKontaktadresse
...
import no.nav.personopplysninger.features.endreopplysningergammel.domain.telefon.EndreTelefon
import no.nav.personopplysninger.features.endreopplysningergammel.domain.telefon.EndringTelefon
import no.nav.personopplysninger.features.personaliagammel.dto.getJson
...
class PersonMottakConsumerGammel (
        private val client: Client,
        private val endpoint: URI,
        private val stsConsumer: STSConsumer
)  {
    private val log = LoggerFactory.getLogger(PersonMottakConsumerGammel::class.java)
