...
import no.nav.personopplysninger.features.endreopplysningergammel.domain.validation.CommonValidation.isNullOrBlank
import no.nav.personopplysninger.features.endreopplysningergammel.domain.validation.CommonValidation.isValidDate
import no.nav.personopplysninger.features.endreopplysningergammel.domain.validation.ValidationResult
import no.nav.personopplysninger.features.endreopplysningergammel.domain.validation.ValidationResult.Companion.invalidResult
import no.nav.personopplysninger.features.endreopplysningergammel.domain.validation.ValidationResult.Companion.validResult
