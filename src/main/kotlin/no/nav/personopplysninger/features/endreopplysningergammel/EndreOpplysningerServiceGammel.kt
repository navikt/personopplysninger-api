...
import no.nav.personopplysninger.features.endreopplysningergammel.domain.kontaktadresse.*
import no.nav.personopplysninger.features.endreopplysningergammel.domain.kontonummer.EndringKontonummer
import no.nav.personopplysninger.features.endreopplysningergammel.domain.kontonummer.Kontonummer
import no.nav.personopplysninger.features.endreopplysningergammel.domain.telefon.EndringTelefon
import no.nav.personopplysninger.features.endreopplysningergammel.domain.telefon.Telefonnummer
import no.nav.personopplysninger.features.endreopplysningergammel.domain.telefon.endreNummerPayload
import no.nav.personopplysninger.features.endreopplysningergammel.domain.telefon.slettNummerPayload
import no.nav.personopplysninger.features.personaliagammel.dto.outbound.adresse.kontaktadresse.DownstreamPostboksadresse
import no.nav.personopplysninger.features.personaliagammel.dto.outbound.adresse.kontaktadresse.DownstreamUtenlandskAdresse
import no.nav.personopplysninger.features.personaliagammel.dto.outbound.adresse.kontaktadresse.DownstreamVegadresse
...
@Service
class EndreOpplysningerServiceGammel (
    private var stsConsumer: STSConsumer,
    private var personMottakConsumer: PersonMottakConsumerGammel,
